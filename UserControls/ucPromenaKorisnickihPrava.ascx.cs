...
namespace MultibukiWeb.UserControls
{
    public partial class ucPromenaKorisnickihPrava : System.Web.UI.UserControl
    {
           ...
           wcfMultibuki.IwcfMultibuki client = new wcfMultibuki.IwcfMultibukiClient();
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        tbImeKorisnika.Text = odgovor.VratiKorisnikaResult.dtVratiKorisnika.Rows[0]["Ime"].ToString();
                        tbPrezimeKorisnika.Text = odgovor.VratiKorisnikaResult.dtVratiKorisnika.Rows[0]["Prezime"].ToString();
                        ddlUloga.SelectedValue = odgovor.VratiKorisnikaResult.dtVratiKorisnika.Rows[0]["IDUloga"].ToString();
                        ddlStatus.SelectedValue = odgovor.VratiKorisnikaResult.dtVratiKorisnika.Rows[0]["Status"].ToString();

                        ddlFirmaKorisnik.SelectedValue = odgovor.VratiKorisnikaResult.dtVratiKorisnika.Rows[0]["IDFirmaKorisnik"].ToString();
        ...
        protected void ddlFirmaKorisnikPopuni()
        {
            ...
            {
                ObradaiObavestenje("Greška pri pozivu servisa u proceduri VratiFirmaKorisnik!  \\n" + ex.Message);
                return;
            }
            try
            {
        ...
        protected void ddlUlogaPopuni()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    ddlUloga.DataBind();
                    ddlUloga.Items.Insert(0, new ListItem(string.Empty, string.Empty));
                }
            }
            catch (Exception ex)
            {
        ...
        protected void btnSacuvaj_OnClick(object sender, EventArgs e)
        {
          ...
          //    red.telefon = Telefon;
            ...
            ulaz.dtaaa.AdddtaaaRow(red);
              ...
              wcfMultibuki.PromenaPravaKorisnikaRequest zahtev = new wcfMultibuki.PromenaPravaKorisnikaRequest(ulaz);
              wcfMultibuki.PromenaPravaKorisnikaResponse odgovor = new wcfMultibuki.PromenaPravaKorisnikaResponse();

              try
              {
                  odgovor = client.PromenaPravaKorisnika(zahtev);
              }
              catch (Exception ex)
              {
                  ObradaiObavestenje("Greška pri pozivu servisa u proceduri PromenaPravaKorisnika!  \\n\\n" + ex.Message);
                  return;
              }
              try
              {
              ...
              {
                  ObradaiObavestenje("Greška u aplikaciji u metodi btnSacuvaj_OnClick!  \\n\\n " + ex.Message);
                  return;
              }
        }
